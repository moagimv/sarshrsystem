...
import za.gov.sars.config.DatasourceUtility;
 ...
 */
@Configuration
@EnableJpaRepositories(basePackages = {"za.gov.sars.persitence"}, transactionManagerRef = "transactionManager")
@ComponentScan(basePackages = {"za.gov.sars", "za.gov.sars.domain"})
